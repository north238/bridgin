<x-guest-layout>
    <div class="p-4 sm:p-7 overflow-auto scrollbar-custom">
        <div class="text-start">
            <h1 class="block text-xl font-semibold text-gray-800">{{ __('register') }}</h1>
        </div>
            ...
            <form method="POST" action="{{ route('register') }}" novalidate>
                ...
                <div class="grid gap-y-4">
                    ...
                    <div class="flex gap-2 justify-center items-center">
                        <p class="block font-medium text-sm text-slate-600">
