                    ...
                    <div class="flex justify-between border-b-2 border-slate-200/50 py-6">
                        ...
                        <div class="flex items-center">
                            ...
                            <a href="javascript:void(0)"
                                ...
                                <svg class="hi-mini hi-square-3-stack-3d inline-block h-5 w-5 rotate-90 text-indigo-500"
                        ...
                        <div class="flex items-center gap-1 lg:gap-5">
                            ...
                            <nav class="flex items-center gap-2">
                                <a href="javascript:void(0)"
                                    ...
                                    <svg class="hi-mini hi-flag inline-block h-5 w-5 text-slate-300 group-hover:text-indigo-500"
                                        xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor"
                                        aria-hidden="true">
                                        <path
                                    ...
                                    <span
                                        class="inline-flex h-6 w-6 items-center justify-center rounded-full border border-indigo-200 bg-indigo-50 text-indigo-900">3</span>
                                </a>
                            </nav>
                            ...
                            <div class="relative inline-block">
                                ...
                                <div x-cloak x-show="userDropdownOpen"
                                    ...
                                    <div class="divide-y divide-slate-100 rounded bg-white ring-1 ring-slate-900/5">
                                        <div class="space-y-1 p-2">
                                            <a role="menuitem" href="javascript:void(0)"
                                                class="group flex items-center gap-2 rounded px-3 py-2 text-sm font-medium text-slate-900 hover:bg-slate-100 hover:text-slate-700"><svg
                    ...
                    <nav x-cloak x-show="mobileNavOpen" class="flex flex-col py-4 lg:hidden">
                        ...
                        <div class="space-y-1.5">
                            <a href="javascript:void(0)"
                                ...
                                <svg class="hi-mini hi-cursor-arrow-rays inline-block h-5 w-5 flex-none text-slate-300 group-hover:text-indigo-500"
                                    xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor"
                                    aria-hidden="true">
                                    <path fill-rule="evenodd"
                            ...
                            <a href="javascript:void(0)"
                                class="group flex items-center justify-between gap-2 rounded-md border border-transparent px-2.5 py-2 text-sm font-semibold text-slate-900 hover:bg-indigo-100 hover:text-indigo-600 active:border-indigo-200">
                                <svg class="hi-mini hi-chart-bar inline-block h-5 w-5 flex-none text-slate-300 group-hover:text-indigo-500"
                                    xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor"
                                    aria-hidden="true">
                                    <path
                        ...
                        <div class="space-y-1.5">
                            <a href="javascript:void(0)"
                                class="group flex items-center justify-between gap-2 rounded-md border border-transparent px-2.5 py-2 text-sm font-semibold text-slate-900 hover:bg-indigo-100 hover:text-indigo-600 active:border-indigo-200">
                                <svg class="hi-mini hi-user-group inline-block h-5 w-5 flex-none text-slate-300 group-hover:text-indigo-500"
                                    xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor"
                                    aria-hidden="true">
                                    <path
                            ...
                            <a href="javascript:void(0)"
                                class="group flex items-center justify-between gap-2 rounded-md border border-transparent px-2.5 py-2 text-sm font-semibold text-slate-900 hover:bg-indigo-100 hover:text-indigo-600 active:border-indigo-200">
                                <svg class="hi-mini hi-briefcase inline-block h-5 w-5 flex-none text-slate-300 group-hover:text-indigo-500"
                                    xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor"
                                    aria-hidden="true">
                                    <path fill-rule="evenodd"
                            ...
                            <a href="javascript:void(0)"
                                class="group flex items-center justify-between gap-2 rounded-md border border-transparent px-2.5 py-2 text-sm font-semibold text-slate-900 hover:bg-indigo-100 hover:text-indigo-600 active:border-indigo-200">
                                <svg class="hi-mini hi-document-text inline-block h-5 w-5 flex-none text-slate-300 group-hover:text-indigo-500"
                                    xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor"
                                    aria-hidden="true">
                                    <path fill-rule="evenodd"
                    ...
                    <div class="grid grid-cols-1 md:gap-20 lg:grid-cols-12">
                        ...
                        <nav class="hidden lg:col-span-3 lg:block">
                            ...
                            <div class="space-y-1.5">
                                ...
                                <a href="javascript:void(0)"
                                    class="group flex items-center justify-between gap-2 rounded-md border border-transparent px-2.5 py-2 text-sm font-semibold text-slate-900 hover:bg-indigo-100 hover:text-indigo-600 active:border-indigo-200">
                                    <svg class="hi-mini hi-lock-closed inline-block h-5 w-5 flex-none text-slate-300 group-hover:text-indigo-500"
                                        xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor"
                                        aria-hidden="true">
                                        <path fill-rule="evenodd"
                        ...
                        <div class="lg:col-span-9">
                            <div class="grid grid-cols-1 gap-4 sm:grid-cols-12 md:gap-6">
                                ...
                                <div
                                    ...
                                    <div class="-m-2">
                                        <svg class="w-auto text-indigo-100" fill="currentColor"
                                ...
                                <div
                                    class="overflow-hidden rounded-xl border border-slate-200 bg-white sm:col-span-12">
                                    <div class="px-6 pt-6">
                                            ...
                                            <table class="min-w-full align-middle text-sm">
                                                ...
                                                <thead>
                                                    <tr class="border-b-2 border-slate-100">
                                                        ...
                                                        <th
                                                            class="hidden px-3 py-2 text-start text-sm font-semibold uppercase tracking-wider text-slate-700 md:table-cell">
                                                            Email
                                                        </th>
                                                        <th
                                                            class="hidden px-3 py-2 text-start text-sm font-semibold uppercase tracking-wider text-slate-700 md:table-cell">
                                                        ...
                                                        <th
                                                            class="px-3 py-2 text-end text-sm font-semibold uppercase tracking-wider text-slate-700">
                                                            Total
                                                        </th>
                                                    </tr>
                                                </thead>
