...
<form id="month-form-data" class="flex items-center" method="POST" action="{{ route('search.index') }}">
    ...
    <div class="calender-input-icon">
        <input type="month" name="form-date" id="form-date" value="{{ $firstOfMonth }}"
            class="bg-white border rounded-s-lg border-gray-300 text-slate-600 dark:text-white focus:ring-blue-400 focus:border-blue-400 block w-full p-2 dark:bg-dark_table dark:border-dark_border dark:placeholder-gray-400 dark:focus:ring-blue-400 dark:focus:border-blue-400"
            required>
