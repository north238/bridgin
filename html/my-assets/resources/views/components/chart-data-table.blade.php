    ...
    @else
        <div class="scrollbar-custom overflow-x-auto min-w-full">
            <table class="text-sm align-middle min-w-full">
                <thead class="text-base bg-slate-500 dark:bg-slate-">
                    <tr class="border-b-2 border-slate-100 dark:border-dark_border">
                        <th scope="col" class="min-w-[180px] px-3 py-2 text-start font-semibold text-white">
                            {{ __('asset_name') }}</th>
                        <th scope="col" class="min-w-[150px] px-3 py-2 text-start font-semibold text-white">
                            {{ __('amount') }}（円）
                        </th>
                        <th scope="col" class="min-w-[110px] px-3 py-2 text-start font-semibold text-white">
                            比率
                        </th>
                    </tr>
                </thead>
                <tbody>
                    @foreach ($data as $key => $arrays)
                        <tr
                            class="border-b border-slate-200 dark:bg-dark_table dark:border-dark_border bg-gray-100 dark:hover:bg-gray-600">
                        ...
                        <tr
                            class="border-b border-slate-200 dark:bg-dark_table dark:border-dark_border hover:bg-gray-50 dark:hover:bg-gray-600">
                            <td class="p-3 pl-5 text-start text-slate-600 dark:text-white">
